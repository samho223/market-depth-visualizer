...
test('renders depth visualizer with certain width and color', () => {
  ...
  expect(divElement).toHaveAttribute('style','background-color: rgb(16, 97, 18); height: 1.250em; width: 33%; position: relative; top: 21px; left: 0px; margin-top: -24px; z-index: 1;')
});
